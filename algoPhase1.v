...
have -> : alpha / 2 = pow (emin - 1).
  rewrite bpow_plus powN1 /alpha /=.
  by lra.
rewrite pow_Rpower //.
apply: exp_increasing.
rewrite -[X in X < _]Ropp_involutive.
rewrite -[X in - X < _]Rabs_pos_eq; last first.
  suff : y * ln x <= 0 by lra.
  have [//|ylnx_pos] := Rle_lt_dec (y * ln x) 0.
